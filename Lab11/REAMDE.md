...
**HTML Report:** [**click here**](https://rawcdn.githack.com/qiushipeng/PM566-Fall2022-Labs/aa04cfe750537c138ff599390e34136d886581c2/Lab11/lab11.html)
...
- Filter to dates after Jun 1, 2022
...
plot_ly(cv_states, x = ~date, y = ~new_cases, color = ~state, type = "scatter", mode = "lines")
...
Create a heatmap to visualize `new_cases` for each state on each date greater than June 1st, 2022
